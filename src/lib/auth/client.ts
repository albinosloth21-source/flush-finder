...
/** Always drop local session and leave the page — used after account deletion. */
export async function endSessionNow(redirectTo = "/"): Promise<void> {
  setBearerToken(null);
  try {
    await authClient.signOut();
  } catch {
    /* cookie may already be invalid after the account row was removed */
  }
